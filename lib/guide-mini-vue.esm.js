...
export { EffectScope, ITERATE_KEY, computed, createApp, createRenderer, createTextVNode, deferredComputed, effect, getCurrentInstance, h, inject, isProxy, isReactive, isReadonly, isRef, markRaw, onScopeDispose, provide, proxyRefs, reactive, readonly, ref, renderSlots, shallowReactive, shallowReadonly, stop, toRaw, toRef, toRefs };
